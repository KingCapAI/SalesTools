...
export function DesignerDashboard() {
  ...
  const [renameTarget, setRenameTarget] = useState<DesignListItem | null>(null);
    ...
    <div className="min-h-screen bg-black">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-8">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-xl sm:text-2xl font-bold text-gray-100 truncate">AI Design Conceptor</h1>
              <p className="text-gray-400 text-sm truncate">Manage and create AI hat design concepts</p>
            </div>
          </div>
          <Link to="/ai-design-generator/new" className="w-full sm:w-auto">
      ...
      {renameTarget && (
        <RenameDesignModal
          ...
          fallbackLabel={`Design #${renameTarget.design_number}`}
          isOpen={true}
...
function DesignCard({ design, onDelete, onRename, isDeleting }: DesignCardProps) {
  return (
